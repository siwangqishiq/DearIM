...
import 'package:flutter_im_client/core/byte_buffer.dart';
import 'package:flutter_im_client/core/imcore.dart';
import 'package:flutter_im_client/log/log.dart';

void main(){
   Future<Socket> socketFuture = Socket.connect(IMClient.SERVER_ADDRESS, IMClient.PORT , 
